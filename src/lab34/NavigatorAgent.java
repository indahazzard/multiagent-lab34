        ...
        public void action() {
            ...
            if (msg != null) {
                if (parseSpeleologistMessageRequest(msg.getContent())){
                    ...
                    System.out.println("lab34.NavigatorAgent: " + WumpusWorldAgent.Constants.INFORMATION_PROPOSAL_NAVIGATOR);
                    myAgent.send(reply);
                } else if (parseSpeleologistMessageProposal(msg.getContent()))
                {
                    ...
                    System.out.println("lab34.NavigatorAgent: " + advice);
                    myAgent.send(reply);

                } else
                    System.out.println("lab34.NavigatorAgent: Wrong message!");
            } else {
                block();
            }
        }
