...
public class WumpusWorldAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("Wumpus world agent " + getAID().getName() + " is ready.");
        System.out.println("Wumpus world agent: Current world state:");
            ...
            if (msg != null) {
                ...
                switch (message) {
                    ...
                    case Constants.SPELEOLOGIST_CLIMB:
                        ...
                        break;
                    default:
                        System.out.println("WumpusWorldAgent: Wrong action!");
                        break;
                }
    ...
    final static class Constants {
        ...
        static final String INITIAL_WUMPUS_CAVE = "P . G . . . P . W . . . S . P . ";
