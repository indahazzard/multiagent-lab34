...
public class SpeleologistAgent extends Agent {
    ...
    private class WumpusWorldFinder extends Behaviour {
        ...
        public void action() {
            ...
            System.out.println("runnin ticker behaviour");
            try {
        ...
        public void action() {
            ...
            switch (step) {
                case 0 -> {
                    ...
                    System.out.println("lab34.SpeleologistAgent: " + WumpusWorldAgent.Constants.ADVICE_PROPOSAL);
                    myAgent.send(inform);
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.REQUEST) {
                            if (parseNavigatorMessageRequest(reply.getContent())) {
                                ...
                                System.out.println("lab34.SpeleologistAgent: There is an unknown command!");
                        }
                    } else {
                ...
                case 2 -> {
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.INFORM) {
                            ...
                            System.out.println("lab34.SpeleologistAgent: " + WumpusWorldAgent.Constants.INFORMATION_PROPOSAL_SPELEOLOGIST + rep);
                            myAgent.send(mes);
                            mt = MessageTemplate.and(MessageTemplate.MatchConversationId(WumpusWorldAgent.Constants.NAVIGATOR_DIGGER_CONVERSATION_ID),
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            switch (action) {
                                ...
                                default -> System.out.println("lab34.SpeleologistAgent: There is no right action!");
                            }
                    ...
                    if (reply != null) {
                        ...
                        switch (answer) {
                            case WumpusWorldAgent.Constants.FAIL_MESSAGE -> {
                                System.out.println("lab34.SpeleologistAgent: You failed!");
                                step++;
                                doDelete();
                            }
                            case WumpusWorldAgent.Constants.OK_MESSAGE -> {
                                System.out.println("lab34.SpeleologistAgent: Wumpus world answers OK.");
                                step = 0;
                            }
                            case WumpusWorldAgent.Constants.WIN_MESSAGE -> {
                                System.out.println("lab34.SpeleologistAgent: The speleologist survived and won!");
                                step++;
                                doDelete();
                            }
                        }
